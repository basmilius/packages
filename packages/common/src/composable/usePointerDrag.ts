import { type MaybeRef, readonly, ref, type Ref, watch } from 'vue';
 ...
 */
export default function <TElement extends HTMLElement>(elementRef: MaybeRef<TElement | null | undefined>, options: UsePointerDragOptions = {}): UsePointerDragReturn {
    ...
    watch(() => unwrapElement(elementRef), (element, _, onCleanup) => {
        if (!element) {
            return;
        }
